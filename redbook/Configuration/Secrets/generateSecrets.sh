...
$PROJECT_DIR/tools/sourcery/bin/sourcery \
  --sources $PROJECT_DIR/redbook/Configuration/Secrets \
  --templates $PROJECT_DIR/redbook/Configuration/Secrets/Secrets.stencil \
  --output $PROJECT_DIR/redbook/Configuration/Secrets/Secrets.swift \
