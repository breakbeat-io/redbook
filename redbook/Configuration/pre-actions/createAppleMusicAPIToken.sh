...
: "${APPLE_DEVELOPER_TEAM_ID?Please set APPLE_DEVELOPER_TEAM_ID in your secrets.xcconfig.}"
...
JWT=$($SCRIPTPATH/amtg -k "$APPLE_MUSIC_KEY_ID" -t "$APPLE_DEVELOPER_TEAM_ID" -p "$APPLE_MUSIC_PRIVATE_KEY_PATH")
